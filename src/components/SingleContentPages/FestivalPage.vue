				...
				<md-tab md-label="History" :md-active="activeTab === 1" class="history-tab">
					...
					<div class="festival-instance" v-for="(festivalEvent, index) in festival.events" :key="index" :slot="'step-' + (index+1)">
						...
						<div class="festival-instance-image">
							<img :src="'https://scontent-dus1-1.xx.fbcdn.net/v/t1.0-9/48370041_1898573640239312_4004983611118845952_n.jpg?_nc_cat=107&_nc_ht=scontent-dus1-1.xx&oh=b30f499a0de3c45baac4d6a39deb73ed&oe=5CB41FFD'" :alt="festivalEvent.name">
						</div>
					</div>
				</stepper>
				</md-tab>
